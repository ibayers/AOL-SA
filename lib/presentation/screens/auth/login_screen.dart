              ...
              child: SingleChildScrollView(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Text('Smart Money', style: AppTextStyles.headlineLarge.copyWith(color: AppColors.primary, fontWeight: FontWeight.w800)),
                    const SizedBox(height: 8),
                    Text('Welcome Back', style: AppTextStyles.titleMedium.copyWith(color: AppColors.outline, fontWeight: FontWeight.w500)),
                    ...
                    Container(
                      ...
                      decoration: BoxDecoration(
                        ...
                        boxShadow: [
                          BoxShadow(color: AppColors.primary.withValues(alpha: 0.04), blurRadius: 48, offset: const Offset(0, 24)),
                        ],
                      ),
                      child: Column(
                        ...
                        children: [
                          ...
                          const SizedBox(height: 8),
                          _buildTextField(controller: _emailController, hint: 'name@company.com', icon: Icons.mail_outline_rounded, keyboardType: TextInputType.emailAddress),
                          ...
                          Row(
                            ...
                            children: [
                              ...
                              GestureDetector(
                                onTap: () {},
                                child: Text('Forgot Password?', style: AppTextStyles.labelMedium.copyWith(color: AppColors.primary, fontWeight: FontWeight.w700)),
                              ),
                            ],
                          ),
                          const SizedBox(height: 8),
                              ...
                              child: Row(
                                ...
                                children: [
                                  if (_isLoading)
                                    ...
                                    Text('Login', style: AppTextStyles.titleMedium.copyWith(color: Colors.white, fontWeight: FontWeight.bold)),
                    ...
                    Row(
                      mainAxisAlignment: MainAxisAlignment.center,
                      children: [
                        Text("Don't have an account? ", style: AppTextStyles.bodyMedium.copyWith(color: AppColors.outline, fontWeight: FontWeight.w500)),
                        GestureDetector(
                          onTap: () => Navigator.push(context, MaterialPageRoute(builder: (_) => const SignUpScreen())),
                          child: Text('Sign Up', style: AppTextStyles.bodyMedium.copyWith(color: AppColors.primary, fontWeight: FontWeight.bold)),
                        ),
                      ],
                    ),
                  ],
