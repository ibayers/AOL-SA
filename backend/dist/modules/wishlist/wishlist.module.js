...
exports.WishlistModule = WishlistModule = __decorate([
    (0, common_1.Module)({
        imports: [typeorm_1.TypeOrmModule.forFeature([wishlist_item_entity_1.WishlistItem]), auth_module_1.AuthModule],
        controllers: [wishlist_controller_1.WishlistController],
        providers: [wishlist_service_1.WishlistService, wishlist_item_repository_1.WishlistItemRepository],
    })
], WishlistModule);
